  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.primaryWhite}}>
      <View
        ...
        <View
          ...
          <View style={{paddingLeft: SIZES.base}}>
            <Text style={{fontSize: 12, color: COLORS.ExtremeDark}}>
              Ayomide
            </Text>
      ...
      <View
        ...
        <Image source={icons.rectangle} style={{flexGrow: 1}} />
      </View>
      ...
      <ScrollView>
        ...
        <View
          ...
          {/* Service Title */}
          <Text style={{marginTop: 23, color: COLORS.TextColorBlue}}>
            Our Services
          </Text>
          {/* Service Details */}
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  {/* Service name */}
                  <Text style={{color: COLORS.TextColorBlue, marginTop: 15}}>
                    Airtime
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
            ...
            <View
              ...
              <View style={{}}>
                ...
                <Text
                  ...
                  Earn as much as N500 for every friend you invite to use
                  TopitUp. Start inviting today and get rewarded.
                </Text>
                <TouchableOpacity
      ...
      <TouchableOpacity
        style={{
          ...
          width: 45,
          height: 45,
          left: Platform.OS === 'android' ? 352 : 326,
          top: Platform.OS === 'android' ? 540 : 709,
